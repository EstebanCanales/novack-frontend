...
import { LogOut, Battery, Users, MapPin, AlertTriangle, History, Activity, Zap } from "lucide-react";
  ...
  const metrics = [
    {
      category: "Cards",
      items: [
        { title: "Active Cards", value: "24", icon: Activity, color: "text-green-400" },
        { title: "Battery Percentage", value: "62%", icon: Battery, color: "text-yellow-400" },
        { title: "Disconnected Cards", value: "3", icon: Zap, color: "text-red-400" },
      ]
    },
    {
      category: "Zones",
      items: [
        { title: "Most transitted zones", value: "Zone B", icon: MapPin, color: "text-blue-400" },
        { title: "People per zone", value: "48", icon: Users, color: "text-purple-400" },
      ]
    },
    {
      category: "Events",
      items: [
        { title: "Alerts for active cards", value: "12", icon: AlertTriangle, color: "text-orange-400" },
        { title: "Number of events", value: "156", icon: Activity, color: "text-cyan-400" },
      ]
    },
    {
      category: "History",
      items: [
        { title: "Movement history", value: "1.2K", icon: History, color: "text-indigo-400" },
        { title: "Day comparison", value: "+15%", icon: Activity, color: "text-green-400" },
      ]
    }
  ];
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 rounded-xl bg-[#07D9D9]/20 border border-[#07D9D9]/30">
              <Activity className="h-8 w-8 text-[#07D9D9]" />
            </div>
            <div>
              ...
              <p className="text-lg text-gray-300">
                Monitoreo en tiempo real de tarjetas y métricas del sistema
              </p>
            </div>
          </div>
        </motion.div>
                ...
                <Card className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl shadow-md hover:border-[#07D9D9]/20 transition-all duration-300">
                  <CardHeader className="pb-3">
                    <CardTitle className="flex items-center justify-between text-sm font-medium">
                      ...
                      <Battery className={`w-5 h-5 ${getBatteryColor(card.percentage)}`} />
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="text-center">
                      <div className={`text-3xl font-bold mb-3 ${getBatteryColor(card.percentage)}`}>
                        {card.percentage}%
                      </div>
        ...
        >
          ...
          <Card className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl shadow-md p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">Zonas Monitoreadas</h3>
