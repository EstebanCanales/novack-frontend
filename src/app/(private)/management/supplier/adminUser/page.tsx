    ...
    <div className="flex flex-col h-full p-3 pl-2 overflow-hidden">
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Usuarios Admin</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </motion.div>
      ...
      <div className="flex-1 overflow-hidden flex gap-3">
        ...
        <motion.section
          ...
          className="w-80 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 overflow-hidden flex flex-col"
        >
          {/* SEARCH BAR */}
          <div className="mb-4">
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    <p
                      className={`font-semibold truncate ${
                        index === 0
                          ? "text-[#07D9D9]"
                          : "text-white group-hover:text-[#07D9D9]"
                      } transition-colors`}
                    >
                      {employee.name}
                    </p>
          ...
          <div className="p-4 border-b border-white/10">
            <div className="flex items-center gap-4">
              <Avatar className="h-20 w-20 border-2 border-[#07D9D9]">
                <AvatarFallback className="bg-[#07D9D9] text-black text-xl font-bold">
                  MG
                </AvatarFallback>
              </Avatar>
              <div className="flex-1">
                ...
                <p className="text-lg text-[#07D9D9]">Desarrolladora Senior</p>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {permissions.map((permission, index) => (
                        <Card
                          key={index}
                          className={`bg-white/5 border ${getStatusColor(permission.status)} rounded-lg hover:scale-105 transition-transform duration-200 cursor-pointer`}
                        >
                          <CardContent className="p-4 text-center">
                            ...
                            <Badge
                              variant="outline"
                              className={getStatusColor(permission.status)}
                            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        <span className="text-slate-400">Horas Esta Semana</span>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5">
                          <Avatar className="h-8 w-8">
                            <AvatarFallback className="bg-[#07D9D9] text-black text-xs">
                              CR
                            </AvatarFallback>
                          </Avatar>
                          <span className="text-sm text-white">
